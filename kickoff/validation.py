...
class Validate:
    ...
    def ksvalidate(self, kstext):
        ...
        ksfile.write(kstext)
        ksfile.close()
        # I am using the ksvalidator, I tried to use the pykickstart modules
        # directly but I couldn't do because, the python 3 version produce an
        # error, I will try again in another time.
